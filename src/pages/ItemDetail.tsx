  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      ...
      <div className="card overflow-hidden animate-slide-up stagger-1">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 px-6 py-8 flex flex-col items-center">
          <div className="w-24 h-24 bg-white/20 rounded-2xl flex items-center justify-center shadow-lg backdrop-blur-sm mb-4 overflow-hidden">
            {item.image ? (
          ...
          <h2 className="text-2xl font-bold text-white text-center">{item.item_name}</h2>
